const events = [
    {
        ...
        startDate: new Date("08/10/2022").setHours(16),
        endDate: new Date("08/10/2022").setHours(19),
        location: 'Generalitat De Catalunya, Barcelona',
        contact: '+3 469 862 3220'
    },
    {
        title: "Munich, Germany",
        startDate: new Date("08/10/2022").setHours(14),
        endDate: new Date("08/10/2022").setHours(17),
    ...
    },
    {
        ...
        startDate: new Date("08/10/2022").setHours(17),
        endDate: new Date("08/10/2022").setHours(19),
        ...
        title: "Nairobi, Kenya",
        startDate: new Date("08/10/2022").setHours(10),
        endDate: new Date("08/10/2022").setHours(12),
        ...
        title: "Umea, Sweden",
        startDate: new Date("08/10/2022").setHours(13),
        endDate: new Date("08/10/2022").setHours(16),
        location: 'Doblen Park, Umea, Sweden',
        contact: '+9 370 400 0002'
    }, {
        title: "Berlin, Germany",
        startDate: new Date("08/10/2022").setHours(15),
        endDate: new Date("08/10/2022").setHours(19),
        ...
        title: "London, UK",
        startDate: new Date("08/10/2022").setHours(12),
        endDate: new Date("08/10/2022").setHours(15),
        ...
        title: "Athens, Greece",
        startDate: new Date("08/10/2022").setHours(17),
        endDate: new Date("08/10/2022").setHours(20),
        ...
        title: "Rome, Italy",
        startDate: new Date("08/10/2022").setHours(9),
        endDate: new Date("08/10/2022").setHours(12),
